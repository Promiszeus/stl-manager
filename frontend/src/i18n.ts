...
export const translations = {
  de: {
    ...
    similarInLibrary: 'In meiner Bibliothek',
    similarOnline: 'Online-Plattformen (KI)',
    searchingSimilarOnline: 'KI vergleicht Online-Modelle auf 6 Plattformen...',
    noSimilarOnlineFound: 'Keine optisch ähnlichen Online-Modelle gefunden.',
    noSimilarOnlineHint: 'Passe die Suchbegriffe oben an oder versuche einen alternativen Begriff.',
    searchKeywords: 'Suchbegriffe',
    refineSearch: 'Neu suchen',
  ...
  en: {
    ...
    similarInLibrary: 'In My Library',
    similarOnline: 'Online Repositories (AI)',
    searchingSimilarOnline: 'AI is comparing online models across 6 platforms...',
    noSimilarOnlineFound: 'No visually similar online models found.',
    noSimilarOnlineHint: 'Try refining the search keywords above or search another query.',
    searchKeywords: 'Search Keywords',
    refineSearch: 'Search Again',
